...
(function(global, factory) { /* global define, require, module */
    ...
    $root.transit_realtime = (function() {
        ...
        transit_realtime.FeedMessage = (function() {
             ...
             * @property {Array.<transit_realtime.IFeedEntity>} [entity] FeedMessage entity
             */
            ...
            FeedMessage.verify = function verify(message) {
                ...
                if (message.entity != null && message.hasOwnProperty("entity")) {
                    ...
                    for (var i = 0; i < message.entity.length; ++i) {
                        error = $root.transit_realtime.FeedEntity.verify(message.entity[i]);
                        if (error)
                            return "entity." + error;
                    }
                }
        ...
        transit_realtime.FeedEntity = (function() {
             ...
             * @property {transit_realtime.ITripUpdate} [tripUpdate] FeedEntity tripUpdate
             * @property {transit_realtime.IVehiclePosition} [vehicle] FeedEntity vehicle
             * @property {transit_realtime.IAlert} [alert] FeedEntity alert
             */
            ...
            FeedEntity.verify = function verify(message) {
                ...
                if (message.vehicle != null && message.hasOwnProperty("vehicle")) {
                    error = $root.transit_realtime.VehiclePosition.verify(message.vehicle);
                    if (error)
                        return "vehicle." + error;
                }
                if (message.alert != null && message.hasOwnProperty("alert")) {
                    error = $root.transit_realtime.Alert.verify(message.alert);
                    if (error)
                        return "alert." + error;
                }
                return null;
        ...
        transit_realtime.TripUpdate = (function() {
             ...
             * @property {transit_realtime.IVehicleDescriptor} [vehicle] TripUpdate vehicle
             * @property {Array.<transit_realtime.TripUpdate.IStopTimeUpdate>} [stopTimeUpdate] TripUpdate stopTimeUpdate
            ...
            TripUpdate.verify = function verify(message) {
                ...
                if (error)
                    return "trip." + error;
                if (message.vehicle != null && message.hasOwnProperty("vehicle")) {
                    error = $root.transit_realtime.VehicleDescriptor.verify(message.vehicle);
                    if (error)
                        return "vehicle." + error;
                }
                if (message.stopTimeUpdate != null && message.hasOwnProperty("stopTimeUpdate")) {
                    ...
                    for (var i = 0; i < message.stopTimeUpdate.length; ++i) {
                        error = $root.transit_realtime.TripUpdate.StopTimeUpdate.verify(message.stopTimeUpdate[i]);
                        if (error)
            ...
            TripUpdate.StopTimeUpdate = (function() {
                 ...
                 * @property {transit_realtime.TripUpdate.IStopTimeEvent} [arrival] StopTimeUpdate arrival
                 * @property {transit_realtime.TripUpdate.IStopTimeEvent} [departure] StopTimeUpdate departure
                ...
                StopTimeUpdate.verify = function verify(message) {
                    ...
                    if (message.departure != null && message.hasOwnProperty("departure")) {
                        error = $root.transit_realtime.TripUpdate.StopTimeEvent.verify(message.departure);
                        if (error)
        ...
        transit_realtime.VehiclePosition = (function() {
             ...
             * @property {transit_realtime.ITripDescriptor} [trip] VehiclePosition trip
             * @property {transit_realtime.IVehicleDescriptor} [vehicle] VehiclePosition vehicle
             * @property {transit_realtime.IPosition} [position] VehiclePosition position
            ...
            VehiclePosition.verify = function verify(message) {
                ...
                if (message.position != null && message.hasOwnProperty("position")) {
                    error = $root.transit_realtime.Position.verify(message.position);
                    if (error)
        ...
        transit_realtime.Alert = (function() {
             ...
             * @memberof transit_realtime
             * @interface IAlert
             * @property {Array.<transit_realtime.ITimeRange>} [activePeriod] Alert activePeriod
             * @property {Array.<transit_realtime.IEntitySelector>} [informedEntity] Alert informedEntity
             * @property {transit_realtime.Alert.Cause} [cause] Alert cause
             * @property {transit_realtime.Alert.Effect} [effect] Alert effect
             * @property {transit_realtime.ITranslatedString} [url] Alert url
             * @property {transit_realtime.ITranslatedString} [headerText] Alert headerText
             * @property {transit_realtime.ITranslatedString} [descriptionText] Alert descriptionText
             */
            ...
            Alert.verify = function verify(message) {
                ...
                if (message.informedEntity != null && message.hasOwnProperty("informedEntity")) {
                    ...
                    for (var i = 0; i < message.informedEntity.length; ++i) {
                        error = $root.transit_realtime.EntitySelector.verify(message.informedEntity[i]);
                        if (error)
                ...
                if (message.url != null && message.hasOwnProperty("url")) {
                    error = $root.transit_realtime.TranslatedString.verify(message.url);
                    if (error)
                        return "url." + error;
                }
                if (message.headerText != null && message.hasOwnProperty("headerText")) {
                    error = $root.transit_realtime.TranslatedString.verify(message.headerText);
                    if (error)
                        return "headerText." + error;
                }
                if (message.descriptionText != null && message.hasOwnProperty("descriptionText")) {
                    error = $root.transit_realtime.TranslatedString.verify(message.descriptionText);
                    if (error)
        ...
        transit_realtime.EntitySelector = (function() {
             ...
             * @property {transit_realtime.ITripDescriptor} [trip] EntitySelector trip
        ...
        transit_realtime.TranslatedString = (function() {
             ...
             * @property {Array.<transit_realtime.TranslatedString.ITranslation>} [translation] TranslatedString translation
             */
